...
| Prompt cache | `minimax_generate_video.py` | **MODIFY / EXTEND** | Preserve cache-key inputs and CPU-resident embeddings. Add schema/version/upstream/model fingerprints and atomic writes. |
